...
namespace M_ventas_y_cc.Controllers
{
    public class APIDETALLES_FACTURAController : ApiController
    {
        ...
        public IHttpActionResult PostDETALLES_FACTURA(DETALLES_FACTURA dETALLES_FACTURA)
        {
            ...
            dETALLES_FACTURA.ENCARGADOId = db.ENCARGADOS.Find(dETALLES_FACTURA.ENCARGADOId.encargadoNum); 
            //   dETALLES_FACTURA.DETALLE_CREDITOId = db.DETALLE_CREDITOS.Find(dETALLES_FACTURA.DETALLE_CREDITOId.numDetCredito);


            dETALLES_FACTURA.fecha = DateTime.Today;
            //   dETALLES_FACTURA.DETALLE_CREDITOId = db.DETALLE_CREDITOS.Find(dETALLES_FACTURA.total);
